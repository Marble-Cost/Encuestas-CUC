                    ...
                    if es_ultima:
                        ...
                        with st.spinner("Registrando sus respuestas..."):
                            if guardar_registro(registro):
                                ...
                                st.markdown('<div class="custom-alert">⚠️ Ocurrió un error al guardar. Intente de nuevo. Si el problema persiste, contacte al equipo de investigación.</div>', unsafe_allow_html=True)
                    else:
                        st.session_state.step += 1
                        st.rerun()
